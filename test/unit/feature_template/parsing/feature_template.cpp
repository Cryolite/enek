...
TEST(FeatureTemplateTest, acceptFloatingLiteral)
{
  ...
  testParse(".0E-0",
            ...
            "");
  testParse("5.",
            "<feature_template type=\"floating\"><floating_literal>5</floating_literal></feature_template>",
            "");
  testParse("5.e1",
            "<feature_template type=\"floating\"><floating_literal>50</floating_literal></feature_template>",
            "");
  testParse("5.e+1",
            "<feature_template type=\"floating\"><floating_literal>50</floating_literal></feature_template>",
            "");
  testParse("5.e-1",
            "<feature_template type=\"floating\"><floating_literal>0.5</floating_literal></feature_template>",
            "");
  testParse("5.E1",
            "<feature_template type=\"floating\"><floating_literal>50</floating_literal></feature_template>",
            "");
  ...
  testParse("5.E-1",
            ...
            "");
  testParse("12.5",
            "<feature_template type=\"floating\"><floating_literal>12.5</floating_literal></feature_template>",
            "");
  testParse("12.5e1",
            "<feature_template type=\"floating\"><floating_literal>125</floating_literal></feature_template>",
            "");
  testParse("12.5e+1",
            "<feature_template type=\"floating\"><floating_literal>125</floating_literal></feature_template>",
            "");
  testParse("12.5e-1",
            "<feature_template type=\"floating\"><floating_literal>1.25</floating_literal></feature_template>",
            "");
  testParse("12.5E1",
            "<feature_template type=\"floating\"><floating_literal>125</floating_literal></feature_template>",
            "");
