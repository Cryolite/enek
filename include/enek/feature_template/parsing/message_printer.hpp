#if !defined(ENEK_FEATURE_TEMPLATE_PARSING_MESSAGE_PRINTER_HPP_INCLUDE_GUARD)
#define ENEK_FEATURE_TEMPLATE_PARSING_MESSAGE_PRINTER_HPP_INCLUDE_GUARD
...
#endif // !defined(ENEK_FEATURE_TEMPLATE_PARSING_MESSAGE_PRINTER_HPP_INCLUDE_GUARD)
